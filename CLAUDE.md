...
[Web前端 / Telegram / 企业微信 / 钉钉]
  ...
  └────────────────────────────────────┘
           ↓
  [Ozon API | 1688/拼多多爬虫 | AI模型(DeepSeek/Claude/MiniMax)]
```
...
| **LLM Factory**              | **Multi-model** (MiniMax/Claude/DeepSeek)    | `src/icross/agents/master/llm.py`                                                |
...
| Dify (reference)   | `vendors/dify/CLAUDE.md`                                                              |
| Next.js (frontend) | `vendors/next.js/CLAUDE.md` (symlink to AGENTS.md)                                    |
| Ant Design         | `vendors/ant-design/CLAUDE.md`                                                        |
